...
@section('content')
	...
	<section class="hero-section">
		@foreach ($tablecontent as $content)
			...
			@if($content->featured == 1 && $content->status==1)
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="/images/{{$content->featured_image}}">
				<div class="hs-text">
					<div class="container">
						<div class="row">
							<div class="col-lg-8">
								<div class="hs-subtitle">Delivers best education</div>
								<h2 class="hs-title">{{$content->title}}</h2>
								<p class="hs-des">{{Str::words(strip_tags($content->description),10)}}</p>
								<a href="/content/view/{{$content->id}}"><div class="site-btn">Read More</div></a>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="gallery-section">
        <div class="section-title text-center">
				<h3>Gallery</h3>
				<p>Some of our beautiful memories.</p>
			</div>
		<div class="gallery">
